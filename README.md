...
| 아이템 | 발표자
:---| :---:
[아이템 1. 생성자 대신 정적 팩터리 메서드를 고려하라]() | [YunDaHyee](https://github.com/YunDaHyee)
[아이템 2. 생성자에 매개변수가 많다면 빌더를 고려하라]() | [YunDaHyee](https://github.com/YunDaHyee)
[아이템 3. private 생성자나 열거 타입으로 싱글턴임을 보증하라]() | [YunDaHyee](https://github.com/YunDaHyee)
